...
public class UIController : MonoBehaviour
{
  ...
  [SerializeField] public string responseTxt;
  ...
  IEnumerator SendAudio(string filePath)
  {
    ...
    using (UnityWebRequest www = UnityWebRequest.Post(apiUrl, form))
    {
      ...
      else
      {
        ...
        responseTxt = www.downloadHandler.text;
  ...
  public void SavePdf()
  {
    ...
    PDFManager.CreateAndSavePdf(retrievedText, modal, transcriptionText, responseTxt);
  }
